...
const projectCards = [
  {
    ...
    title: "企业级 RAG 知识资产平台",
    badge: "知识资产",
    icon: "database",
    visual: "db",
    summary: "构建企业知识资产底座，让文档成为可检索、可复用、可追踪的生产力。",
    rows: [
      ["业务场景", "企业内部多源文档分散，检索成本高，知识难沉淀与复用。"],
...
const casePages = {
  "enterprise-rag.html": {
    title: "企业级 RAG 知识资产平台",
    subtitle: "构建企业知识资产底座，让文档成为可检索、可复用、可追踪的生产力。",
    badge: "项目案例",
    tags: ["企业知识平台", "RAG 问答", "权限管控", "多源异构文档", "可追溯"],
    icon: "database",
    sideMeta: [
      ["角色", "AI 应用项目经理"],
      ["行业", "政企 / 知识管理"],
    ...
    modules: [
      {
        num: "01",
        title: "业务场景",
        body: "企业内部存在制度、流程、报告、合同、技术资料等文档，分散在不同系统与团队中。员工查找成本高，知识沉淀利用率低，重复提问与跨部门协作成本偏高。",
        extra: "本项目面向企业员工与业务系统，提供统一的知识检索与问答服务，支持日常办公、业务决策与培训赋能。",
      },
      {
        num: "02",
        title: "目标与边界",
        list: [
          "建设多源异构文档的知识资产底座。",
          "提供高质量的检索与问答能力，提升知识获取稳定。",
          "具备权限管控与来源追溯能力，保障合规与安全。",
      ...
      },
      {
        num: "03",
        title: "逻辑架构",
        flow: ["文档接入", "切分策略", "向量检索", "Rerank", "答案生成", "权限与溯源"],
        footer: ["基础支撑层", "文档存储", "向量数据库", "权限目录", "日志与审计", "运行监控"],
      },
      {
        num: "04",
        title: "AI 参与方式",
        rows: [
          ...
          ["安全增强", "幻觉控制、敏感内容过滤和可追溯输出。"],
        ],
      },
      {
        num: "05",
        title: "实现路径",
        steps: ["需求梳理与范围确认", "数据接入与治理", "检索链路搭建", "答案生成与评估", "安全巡检与上线运营"],
      },
      {
        num: "06",
        title: "当前问题",
      ...
      },
      {
        ...
        columns: [
          ...
          ["产品与文档同步上限", "数据治理、切分策略与鉴权是决定性因素，需要持续优化评估。"],
          ["安全与可追溯是底线", "权限、审计、来源可追溯必须做在产品能力中，才能长期可用。"],
        ],
      },
    ],
  },
...
function renderHomeReal() {
  ...
  const homeProjects = [
    ["enterprise-rag.html", "proj-rag", "企业级 RAG 知识资产平台", "面向企业的知识资产底座，支持文档检索、知识问答、权限控制与溯源。", "产品定义"],
  ...
  const projects = [
    ["enterprise-rag.html", "database", "企业级 RAG 知识资产平台", "面向企业的知识资产底座，支持文档检索、知识问答、权限控制与溯源。", "知识资产"],
  ...
  const projects = [
    {
      ...
      summary: "构建企业知识资产底座，让文档成为可检索、可复用、可追踪的生产力。",
      rows: [
        ["业务场景", "企业内部多源文档分散，检索效率低，知识难沉淀与复用。"],
...
function renderEnterpriseRag() {
  ...
  const facts = [
    ["user", "角色", "AI 应用项目经理"],
    ["building-2", "行业", "政企 / 知识管理"],
    ["clock", "项目周期", "2026.03 - 至今"],
    ["users", "团队规模", "产品 / 算法 / 工程 / 测试"],
  ...
  const aiRows = [
    ...
    ["shield-check", "安全增强", "幻觉抑制、敏感内容过滤、越权访问拦截，保证答案可靠。"],
  ];
  const pathSteps = [
    ["01", "需求梳理与范围确认", "梳理业务场景、知识范围与角色，确定优先级。"],
    ["02", "数据接入与治理", "多源文档接入、去重、权限绑定与元数据治理。"],
    ["03", "检索链路搭建", "切分策略设计、向量化、检索与重排方案落地。"],
    ["04", "答案生成与评估", "Prompt 设计、引用与溯源、人工评测与迭代。"],
    ["05", "安全巡检与上线运营", "权限与审计机制完善，上线灰度与持续运营优化。"],
  ];
  const warnings = [
    ["Chunk 质量", "部分复杂文档结构切分效果不佳，影响检索与生成质量。"],
    ["召回评估", "缺乏标准化评估集与持续自动化评估机制，效果波动难量化。"],
  ...
  const reflections = [
    ...
    ["clipboard-list", "产品与文档的同步上限", "数据治理、切分策略与鉴权是决定性因素，需要持续优化评估。"],
    ["shield-check", "安全与可追溯是企业级落地的底线", "权限、审计、来源可追溯必须做在产品能力中，才能长期可用。"],
  ];

  mount(`
    <section class="rag-stage" aria-label="企业级 RAG 知识资产平台">
      <div class="rag-canvas" data-design-width="1536" data-design-height="1024">
        <div class="rag-breadcrumb">AI项目 <span>›</span> 项目案例 <span>›</span> 企业级 RAG 知识资产平台</div>

        <aside class="rag-sidebar">
          <div class="rag-side-title">项目案例</div>
          <h2>企业级 RAG 知识资产平台</h2>
        ...
        <main class="rag-main">
          <section class="rag-hero">
            <div>
              ...
              <h1>企业级 RAG 知识资产平台</h1>
              <p>构建企业知识资产底座，让文档成为可检索、可复用、可追踪的生产力</p>
              <div class="rag-tags">
                ${["企业知识平台", "RAG 问答", "权限管控", "多源异构文档", "可追溯"].map((tag) => `<span>${tag}</span>`).join("")}
              </div>
            </div>
          ...
          <section class="rag-card rag-card-scenario" id="rag-1">
            ...
            <p>企业内部存在大量制度、流程、报告、合同、技术资料等文档，分散在不同系统与团队中，员工查找成本高，知识沉淀利用率低，重复提问与跨部门协作效率偏低。</p>
            <p>本项目面向企业员工与业务系统，提供统一的知识检索与问答服务，支撑日常办公、业务决策与培训赋能</p>
          </section>
          ...
          <section class="rag-card rag-card-goal" id="rag-2">
            ...
            <h3>目标</h3>
            <ul>
              <li>打通多源异构文档，构建企业知识资产底座</li>
              <li>提供高质量的检索与问答能力，提升知识获取效率。</li>
              <li>具备权限管控与可追溯能力，保障合规与安全</li>
            </ul>
            <h3>边界</h3>
            <ul>
          ...
          <section class="rag-card rag-card-arch" id="rag-3">
            ...
            <div class="rag-arch-footer">
              ${["基础支撑层", "文档存储", "向量数据库", "权限目录", "日志与审计", "运行监控"].map((item) => `<span>${item}</span>`).join("")}
            </div>
          </section>
...
function renderAgentOpsStudio() {
  const caseLinks = [
    ["enterprise-rag.html", "企业级 RAG 知识资产平台"],
...
function renderResume() {
  ...
  const core = [
    ...
    ["database", "企业级 RAG", "知识资产梳理与检索体系设计，关注来源追溯、权限边界和质量评估。"],
  ...
  const aiProjects = [
    ["企业级 RAG 知识资产平台", "企业知识库检索、问答、权限控制与来源追溯，提升内部知识复用效率。", ["RAG", "知识中台", "权限溯源"]],
